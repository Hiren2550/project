      ...
      <div className="container py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-blue-500 ">info@fancall.in</p>
          </div>
          <div className="flex flex-col items-center justify-center text-center">
            <span className="p-3 text-blue-500 rounded-full bg-blue-100/80 ">
              <svg
            ...
            <p className="mt-2 text-blue-500 ">
              Zion Z1, 1304, Sindhu Bhavan Marg, near Maple County Road,
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-gray-500 ">Mon-Fri from 10 AM to 7 PM.</p>
            <p className="mt-2 text-blue-500 ">+91 (886) 668-6666</p>
          </div>
        </div>
      </div>
    </section>
